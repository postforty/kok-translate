...
* **Markdown Viewer Support**: Beautifully renders bold (`**`), lists (`*`, `1.`), inline code, and code blocks (```` ``` ````) generated by Gemini AI with a secure zero-dependency parser. Toggleable in options.
