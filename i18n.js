  ...
  const I18N = {
    dictionaries: {
      ko: {
        ...
        geminiModelPlaceholder: "gemini-3.5-flash-lite",
        geminiModelDesc: "기본값(gemini-3.5-flash-lite) 외에 사용할 모델 ID를 직접 입력할 수 있습니다.",
        targetLanguageLabel: "최종 번역 언어 (Target Language)",
        targetLanguageDesc: "번역 결과로 출력할 목표 언어를 설정합니다.",
        targetLangAuto: "스마트 자동 (한국어 ↔ 영어)",
        targetLangKo: "한국어 (Korean)",
        targetLangEn: "영어 (English)",
        targetLangJa: "일본어 (Japanese)",
        targetLangZh: "중국어 (Chinese)",
        targetLangEs: "스페인어 (Spanish)",
        targetLangFr: "프랑스어 (French)",
        targetLangDe: "독일어 (German)",
        targetLangRu: "러시아어 (Russian)",
        targetLangVi: "베트남어 (Vietnamese)",
        targetLangHi: "힌디어 (Hindi)",
        uiLanguageLabel: "UI 언어 (Language)",
        langAuto: "시스템 기본값 (자동 감지)",
        langKo: "한국어 (Korean)",
        langEn: "English",
        enableMarkdownLabel: "마크다운 서식 뷰어 사용",
        enableMarkdownDesc: "번역 결과의 코드, 목록, 굵은 글씨 등을 마크다운 서식으로 깔끔하게 렌더링합니다.",
        saveBtn: "저장하기",
      ...
      en: {
        ...
        geminiModelPlaceholder: "gemini-3.5-flash-lite",
        geminiModelDesc: "Custom model ID can be specified (default: gemini-3.5-flash-lite).",
        targetLanguageLabel: "Target Language",
        targetLanguageDesc: "Select the target language for translation results.",
        targetLangAuto: "Smart Auto (Korean ↔ English)",
        targetLangKo: "Korean",
        targetLangEn: "English",
        targetLangJa: "Japanese",
        targetLangZh: "Chinese",
        targetLangEs: "Spanish",
        targetLangFr: "French",
        targetLangDe: "German",
        targetLangRu: "Russian",
        targetLangVi: "Vietnamese",
        targetLangHi: "Hindi",
        uiLanguageLabel: "UI Language",
        langAuto: "System Default (Auto Detect)",
        langKo: "한국어 (Korean)",
        langEn: "English",
        enableMarkdownLabel: "Use Markdown Viewer",
        enableMarkdownDesc: "Render translation results with markdown formatting (code blocks, lists, bold, etc.).",
